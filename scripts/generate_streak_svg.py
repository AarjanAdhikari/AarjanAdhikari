...
USER = sys.argv[1] if len(sys.argv) > 1 else "AarjanAdhikari"
...
for i, c in enumerate(contribs):
    ...
    rects.append(f'<rect class="{cls}" x="{x}" y="{y}" width="{CELL}" height="{CELL}" rx="{RAD}" fill="{COLORS[lvl]}" style="animation-delay:{delay}s"/>')
